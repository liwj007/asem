...
public class FlowTemplateStep implements Serializable {
    private Long id;
    ...
    public FlowTemplateStep(Long id, String name, Long flowTemplateId, String description) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object that) {
        ...
        FlowTemplateStep other = (FlowTemplateStep) that;
