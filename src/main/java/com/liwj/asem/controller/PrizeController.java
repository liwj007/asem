...
public class PrizeController {
    ...
    public ResponseData getManagePrizeLists(@RequestParam(value = "token") String token,
        ...
        PageInfo pageInfo = prizeService.getManagePrizeLists(user, pageNum, pageSize);
    ...
    public ResponseData getScholarshipSelectionForQuotaFeedback(@RequestParam(value = "token") String token) throws WSPException {
        User user = userService.getUserByToken(token);
        List<SelectOfScholarshipBO> bo = prizeService.getScholarshipSelectionForQuotaFeedback(user);
        ResponseData responseData = new ResponseData();
